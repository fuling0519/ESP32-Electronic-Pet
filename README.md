...
- 清醒時飽食或清潔連續為 0 六小時會生病；Treat 可治療，若需求持續為 0，六小時後可再次生病。生病後累計 24 小時清醒時間會死亡；死亡後核心資料停止餵食、清潔、治療與時間推進，死亡畫面及後續流程尚未實作。
- `Save` 只有初始化占位，尚無保存／載入；每次開機重新建立預設寵物。
- 蛋、孵化、遊戲、一般睡眠、Deep Sleep、死亡畫面／後續處理及墓碑群皆未實作；餵食、清潔及治療是首版可操作流程，尚未實機驗收。
...
- A3 已有清醒狀態更新、暫存年齡、UI 數值同步、六小時疾病門檻、24 小時清醒疾病死亡門檻及餵食／清潔／治療入口；下一步是死亡畫面與墓碑流程、寵物身分及保存。原先數值下降已獲使用者實機驗收；新增操作頁、病情與死亡仍待上板。體力不在 MVP。
